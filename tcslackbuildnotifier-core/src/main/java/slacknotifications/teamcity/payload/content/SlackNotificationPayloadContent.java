...
/*
    ...
    private void populateCommonContent(SBuildServer server, SRunningBuild sRunningBuild, SFinishedBuild previousBuild,
		...
		setBuildDescriptionWithLinkSyntax(String.format(getBuildResult() + " - " + "<" + getBuildStatusUrl() + "|" + sRunningBuild.getBuildType().getFullName() + " #" + sRunningBuild.getBuildNumber() + branchSuffix + ">"));
    }
